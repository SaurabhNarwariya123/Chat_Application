  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center
     justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <img src={assest.logo_big} alt=""  className='w-[min(30vw,250px)]'/>
        ...
        <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
         <h2  className='font-medium text-2xl flex justify-between items-center' >  
          ...
          src={assest.arrow_icon} alt="" className='w-5 cursor-pointer'/>
          }
             ...
             {!isDataSubmitted && (
                    <>
                     <input onChange={(e)=>setEmail(e.target.value)} value={email}
                      ...
                      border-gray-500 rounded-md focus:outline focus:ring-2
              ...
              {currState === "Sign up" && isDataSubmitted && (
               ...
               <div className='flex flex-col gap-2'>
                  {currState  === "Sign up" ? (
                    <p className='text-sm text-gray-600'>Already hava an account
                    ...
                    <p className='text-sm text-gray-600'>Create an acoount 
